<x-layout.app title="Detail Course" activeMenu="course.show" :withError="true">
     <div class="container my-5">
        <x-breadcrumb title="Detail Course" :breadcrumbs="[
                    ...
                    <div>
                        ...
                        @can('etest course delete')
                            <form action="{{ route('course.destroy', $course) }}"
                                ...
                                @csrf @method('DELETE')
                                <x-input.confirm-button text="Data course ini akan dihapus!"
