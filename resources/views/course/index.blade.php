        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('etest course create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('course.create') }}" class="btn btn-primary w-100 w-md-fit">
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari course...</span>
                    </div>
                </div>

                <div id="course-table">
                    @include('course.includes.index-table', compact('course'))
                </div>
            </div>
        </div>
    </div>
