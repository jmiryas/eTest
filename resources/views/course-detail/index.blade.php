        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('etest course-detail create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('course-detail.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control"
                                placeholder="Cari course detail..." value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('course-detail.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#course-detail-table" hx-push-url="true" hx-indicator="#search-loading"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari course detail...</span>
                    </div>
                </div>

                <div id="course-detail-table">
                    @include('course-detail.includes.index-table', compact('courseDetail'))
                </div>
            </div>
        </div>
    </div>
