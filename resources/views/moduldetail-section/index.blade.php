<x-layout.app title="Moduldetail Section" activeMenu="moduldetail-section" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Moduldetail Section" :breadcrumbs="[
            ['label' => 'Dashboard', 'url' => url('/')],
            ['label' => 'Moduldetail Section'],
        ]" />

        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('etest moduldetail-section create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('moduldetail-section.create') }}" class="btn btn-primary w-100 w-md-fit">
                    ...
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="input-group">
                            <input
                                ...
                                name="search"
                                class="form-control"
                                placeholder="Cari moduldetail section..."
                                value="{{ old('search', request('search')) }}"
                                hx-get="{{ route('moduldetail-section.index') }}"
                                hx-trigger="keyup[keyCode==13], keyup changed delay:500ms"
                                hx-target="#moduldetail-section-table"
                                hx-push-url="true"
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari moduldetail section...</span>
                    </div>
                </div>

                <div id="moduldetail-section-table">
                    @include('moduldetail-section.includes.index-table', compact('moduldetailSection'))
                </div>
            </div>
        </div>
    </div>
