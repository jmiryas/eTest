<x-layout.app title="Modul" activeMenu="modul" :withError="true">
    <div class="my-5 container-fluid">
        <x-breadcrumb title="Modul" :breadcrumbs="[
        ...
        <div class="card">
            <div class="card-header">
                <div class="row g-3 justify-content-between align-items-center">
                    @can('etest modul create')
                        <div class="col-12 col-md-auto">
                            <a href="{{ route('modul.create') }}" class="btn btn-primary w-100 w-md-fit">
            ...
            <div class="card-body table-container">
                <div id="search-loading" class="htmx-indicator">
                    <div class="flex-row px-4 py-3 mx-auto mt-5 text-center card d-flex justify-content-center justify-items-center"
                        ...
                        <span>Sedang mencari modul...</span>
                    </div>
                </div>

                <div id="modul-table">
                    @include('modul.includes.index-table', compact('modul'))
                </div>
            </div>
        </div>
    </div>
